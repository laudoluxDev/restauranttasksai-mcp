...
Go to `https://restauranttasksai.com/connect` and enter the connection code shown by the installer.

## The account is not found

Use the same email address used for RestaurantTasksAI signup or purchase. Manual license-key entry is available only as a fallback.
